...
enum ActionType {atNone, atSelect, atSelectBox, atDeselectBox,
...
public:
   ...
   // Compiler-happy?
   TBaseTriangle& operator= (TBaseTriangle &v) { return *this; };
};
...
// void		*Parent;
   ...
   // Compiler-happy?
   TRealVertex& operator= (TRealVertex &v) { return *this; };
};
